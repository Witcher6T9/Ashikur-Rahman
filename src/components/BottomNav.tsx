              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {onOpenChat && (
                  <button
                    ...
                    className="flex items-center gap-2.5 p-3 rounded-2xl border border-emerald-500/40 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 hover:from-emerald-100 hover:to-teal-100/80 text-[#17343a] text-left transition-all shadow-2xs group cursor-pointer relative"
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-2">
                ...
                {onOpenAndroidPackage && (
                  <button
                    ...
                    className="flex flex-col items-center justify-center p-2.5 rounded-2xl bg-[#e8f3f4] border border-[#176f78]/30 hover:bg-[#d6ebed] transition-colors"
                    title="Install or Package Android App (com.debonair.iedailycontrol)"
                  >
                    <Smartphone className="w-4 h-4 text-[#176f78]" />
                    <span className="text-[10px] font-bold text-[#176f78] mt-1">Android App</span>
                  </button>
                )}
              </div>
            </div>
