      ...
      <div className="mx-auto max-w-[1500px] px-3 sm:px-6">
        <div className="flex h-14 sm:h-16 items-center justify-between gap-1.5 sm:gap-4 w-full">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            {/* Enterprise Factory / Industry Identity Pill */}
            {onOpenFactorySettings && (
              <button
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            {/* RBAC Role & Scope Button */}
            {onOpenRoles && (
              <button
                id="top-rbac-role-pill"
                type="button"
                onClick={onOpenRoles}
                title={`Debonair LTD RBAC: ${profile?.jobTitle || 'Sr. Manager'} - Click to open RBAC Tier Summary & Controls`}
